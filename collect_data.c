...
void SYS_Init(void)
{
    ...
    GPIO_DISABLE_DIGITAL_PATH(PA, 0x7);
...
void AdcSingleCycleScanModeTest()
{
    ...
    printf("\n");
    printf("+----------------------------------------------------------------------+\n");
    printf("|                 ADC single cycle scan mode            |\n");
    printf("+----------------------------------------------------------------------+\n");
    ...
    while(1)
    {
        ...
        if(u8Option == '1')
        {
            ...
            /* Set the ADC operation mode as single-cycle, input mode as single-end and
                 enable the analog input channel 0, 1, 2 */
            ...
            while(!ADC_GET_INT_FLAG(ADC, ADC_ADF_INT));
						...
						R_value = ADC_GET_CONVERSION_DATA(ADC, 0);
						G_value = ADC_GET_CONVERSION_DATA(ADC, 1);
						B_value = ADC_GET_CONVERSION_DATA(ADC, 2);
						
						printf("{%d, %d, %d},", R_value, G_value, B_value);
